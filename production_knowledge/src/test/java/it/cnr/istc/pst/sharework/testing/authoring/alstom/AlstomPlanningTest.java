package it.cnr.istc.pst.sharework.testing.authoring.alstom;
 ...
 *
 */
public class AlstomPlanningTest
{
    private static final String ONTOLOGY_PATH = ProductionKnowledge.SHAREWORK_KNOWLEDGE +  "etc/ontologies/soho_alstom_v0.1.owl";
    private static final String RULE_PATH = ProductionKnowledge.SHAREWORK_KNOWLEDGE +  "etc/ontologies/soho_rules_v1.0.rules";
    private static final String PDL = ProductionKnowledge.SHAREWORK_KNOWLEDGE +  "gen/alstom.pdl";
